...
<body>
    ...
    <div class="wrapper">
        ...
        <footer class="marquee-footer">
            <marquee class="mb-0" scrollamount='9'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ducimus
                deserunt voluptatum ab totam quasi dolores maxime natus amet, quaerat ratione, odit cupiditate sequi
                accusamus omnis labore, nobis dolore? Quam, maxime.</marquee>
        </footer>
    </div>
