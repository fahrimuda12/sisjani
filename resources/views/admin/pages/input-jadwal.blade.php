                            ...
                            <div class="card-body">
                                ...
                                <form class="row g-2" action="/admin/jadwal/input" method="POST">
                                    ...
                                    <input name="nama" class="form-control mb-3" type="text"
                                        placeholder="Masukkan Nama Rapat" aria-label="default input example" required>
                                    ...
                                    <input name="tgl_mulai" class="form-control mb-3" type="date" class="form-control"
                                        required>
                                    <div class="col-md-6">
                                        <label class="form-label">Jam Mulai</label>
                                        <input name="tgl_mulai" class="form-control mb-3" type="time"
                                            class="form-control" required>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label">Jam Selesai</label>
                                        <input name="tgl_selesai" class="form-control mb-3" type="time"
                                            class="form-control" required>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label">Jumlah Snack</label>
                                        <div class="input-group mb-3">
                                            <input name="snack" type="number" max="1000" class="form-control"
                                                placeholder="Masukkan Jumlah Snack" aria-label="snack"
